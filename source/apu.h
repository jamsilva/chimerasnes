...
enum
{
	DEFAULT_ONE_APU_CYCLE = 21,
	FREQUENCY_MASK        = 0x3fff
};
...
uint8_t APUGetByteDP(uint8_t Address);
void    APUSetByteDP(uint8_t byte, uint8_t Address);
...
static INLINE void APUExecute()
{
	...
	while (APU.Cycles < APUGetCPUCycles())
	{
